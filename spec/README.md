...
| [0017](decision-records/0017-low-side-comparator-pmos-respin-supply-slope.md) | Low-side comparator re-referenced to a complementary PMOS-input cell — `t_cmp_l`'s supply span collapses 24× (delay share 62–82% → 7.6–33%), Row 4's Iq margin widens 1.24 → 24.2 µA | Ratified (supersedes 0016's Row-3 re-derivation: at-calibration −2.9%/+2.0%, full-range +8.8%/−10.8%; DR-0016's instrumentation and stage findings stand) |
