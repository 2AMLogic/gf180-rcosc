...
| Free-running, post-trim, **full temperature range** (−40…+85 °C, VDD ±10%) | **+8% / −9%** worst-case | dominated by gf180mcu's published poly-resistor TCR of −1200 ppm/K (§6.1A), trimmed at 27 °C: ΔR/R = −6.96% at +85 °C (58 K) so f rises +6.84%, ΔR/R = +8.04% at −40 °C (67 K) so f falls −7.91%, plus the ±1.1% above — DR-0003. **Resolved by DR-0004: no active TC compensation is added; this figure stands as the free-running spec, and closing the gap to USB compliance is entirely the job of the runtime-disciplined row below** |
