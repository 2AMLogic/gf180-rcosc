...
| [`IQNEW`](iq/results/IQNEW/README.md) | Post-#39 Iq PVT factorial (issue #39), self-biased current-reference core, `RZ L = 32 µm`. 63-point grid x codes `0x00`/`0x80`/`0xC0`/`0xFF` = 252 points. IQRUN. See [DR-0012](../spec/decision-records/0012-comparator-bias-path-pvt-revision.md). |
